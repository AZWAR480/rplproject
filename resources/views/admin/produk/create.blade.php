  ...
  <header>
    ...
    <nav>
      <div class="nav-wrapper indigo darken-2">
        ...
        <a class="breadcrumb">Create Product</a>
  ...
  <main>
    ...
    <form action="{{ route('admin.products.store') }}" method="POST">
      ...
      <div class="input-field col s12">
        <input id="nama_barang" name="nama_barang" type="text" class="validate" required>
        <label for="nama_barang">Nama Barang</label>
      </div>
      <div class="input-field col s12">
        <input id="kategori_barang" name="kategori_barang" type="text" class="validate" required>
        <label for="kategori_barang">Kategori Barang</label>
      </div>
      <div class="input-field col s12">
        <textarea id="deskripsi_barang" name="deskripsi_barang" class="materialize-textarea" required></textarea>
        <label for="deskripsi_barang">Deskripsi Barang</label>
      </div>
      <div class="input-field col s12">
        <textarea id="spesifikasi_barang" name="spesifikasi_barang" class="materialize-textarea" required></textarea>
        <label for="spesifikasi_barang">Spesifikasi Barang</label>
      </div>
      <div class="input-field col s12">
        <input id="harga_barang" name="harga_barang" type="number" class="validate" required>
        <label for="harga_barang">Harga Barang</label>
      </div>
      <button type="submit" class="btn pink">Tambah Produk</button>
